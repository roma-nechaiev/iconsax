<svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" aria-hidden="true" viewBox="0 0 24 24" {{ $attributes }}>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15Z" opacity="0.34"/>
</svg>
